...
1.  Now write a new function that solves this problem for the two coin problem via the Metropolis algorithm. Then use the function to solve the same problem you just solved analytically in the previous question. This is also illustrated in Figure 7.6. Your code should reproduce the result shown in Figure 7.6. I will add some details here to help you out with that. Check back.

1.  There will be a question here pertaining to Gibbs sampling.

1.  There may be other questions as well.